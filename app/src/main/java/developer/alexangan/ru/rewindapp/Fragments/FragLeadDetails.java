...
public class FragLeadDetails extends Fragment implements View.OnClickListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            leadInfoItem = getArguments().getParcelable("leadInfoItem");
    ...
    {
        View rootView = inflater.inflate(R.layout.frag_lead_details, container, false);

        FrameLayout llReturn = (FrameLayout) rootView.findViewById(R.id.llReturn);
