package developer.alexangan.ru.rewindapp.Caldroid;
...
public class CaldroidFragment extends DialogFragment {
    ...
    private Formatter monthYearFormatter = new Formatter(
            monthYearStringBuilder, Locale.ITALIAN);
    ...
    private FrameLayout calendar_title_view;
...
/*        String monthTitle = DateUtils.formatDateRange(getActivity(),
        ...
        //String periodDisplayed = ItalianMonths.numToLongString(firstMonthTime.month) + " " + firstMonthTime.year;
        String periodDisplayed = getMonth(firstMonthTime.month, Locale.ITALIAN) + " " + firstMonthTime.year;

        monthTitleTextView.setText(MyTextUtils.toDisplayCase(periodDisplayed));
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = localInflater.inflate(R.layout.caldroid_calendar_view, container, false);
        ...
        calendar_title_view = (FrameLayout) view.findViewById(R.id.calendar_title_view);

        calendar_title_view.setOnTouchListener(new OnSwipeTouchListener(getActivity())
        {
            @Override
    ...
    protected ArrayList<String> getDaysOfWeek() {
        ...
        // EEEEE for first letter only
        SimpleDateFormat fmt = new SimpleDateFormat("EEEEE", Locale.ITALIAN);
